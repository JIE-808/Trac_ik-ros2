...
def parse_args():
    ...
    parser.add_argument("--urdf", required=True, help="Path to robot URDF/XML file")
    parser.add_argument("--base-link", default="torso_lift_link")
    parser.add_argument("--tip-link", default="r_wrist_roll_link")
    return parser.parse_args()


if __name__ == '__main__':
    args = parse_args()
    urdf = Path(args.urdf).read_text(encoding='utf-8')
    ...
    ik_solver = TRAC_IKSolver(args.base_link,
                              args.tip_link,
                              urdf,
